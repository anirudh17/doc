...
<html class="fixed">
	<head>
		...
		<title><?php echo $emp_id;?>Salesman Page</title>
            ...
            <div class="col-md-4 col-lg-3">
								<section class="panel">
									...
									<div class="panel-body">
										...
										<hr class="solid short">
										<p><a href="#"  id="menu1" onclick="loadDiv('menu1');"><i class="fa fa-phone mr-xs" ></i> Contact Admin</a></p>
								...
								<ul class="simple-card-list mb-xlg">
									...
									<li class="primary">
										<h3>16</h3>
										<p>Incompleted Visits Count</p>
									</li>
								</ul>

								<h4 class="mb-md">Past Visited</h4>
										 ...
										 <div class="panel-body">
											 <table class="table table-bordered table-striped mb-none" id="datatable-details">
												 ...
												 <tbody id="loadtabledata">
													 <tr class="gradeX">
														 <td>1</td>
														 <td>Shivajinagar to Aundh</td>
														<td class="center">2018-12-03</td>
														 <td class="center">4</td>

													 </tr>
													 <tr class="gradeC">
														 <td>2</td>
														 <td>Shivajinagar to Kothrud</td>
														 <td class="center">2018-12-03</td>
