	...
	<body>
		<section class="body">
			...
			<div class="inner-wrapper">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Assign Routes to Saller</span></li>
							</ol>
				...
				<h2 class="text-center">Assign Routes to Saller</h2>
					</header>
					<div class="wizard-tabs">
						<ul class="wizard-steps">
							<li class="active">
								<a href="#" data-toggle="tab" class="text-center">
									<span class="badge hidden-xs " id="showsalesman" onclick="showstable();">SHOW SALESMAN INFO</span>
								</a>
							</li>
							<li >
								<a href="#" data-toggle="tab" class="text-center">
									<span class="badge hidden-xs" onclick="showform();">ASSIGN SALESMAN</span>
								</a>
							</li>
						</ul>
					</div>
					...
					<table class="table table-bordered table-striped mb-none" id="datatable-default">
						<thead>
							<tr>
								...
								<th class="text-center">Route Details Id</th>
